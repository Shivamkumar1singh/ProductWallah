        ...
        <div class="user-profile card user-card mb-4">
          <div class="card-header border-0 p-0 pb-0">
            <div class="cover-img-block">
              <img src="{{ $vendor->cover_image ? asset('storage/'.$vendor->cover_image) : asset('admin/assets/images/cover.jpg') }}" class="img-fluid w-100" alt="Cover Image">
              <div class="overlay"></div>
              <div class="change-cover">
                {{-- CHANGE COVER --}}
                <form action="{{ route('vendor.profile.cover') }}" method="POST" enctype="multipart/form-data" class="change-cover">
                    @csrf
                    ...
                    <label class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a
                                href="{{ route('vendor.profile.cover.remove') }}"
            ...
            <div class="user-about-block m-0">
              <div class="row">
                <div class="col-md-4 text-center mt-n5">
                  {{-- PROFILE IMAGE --}}
                    <form action="{{ route('vendor.profile.avatar') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                  ...
                  <p class="mb-2 text-muted">Vendor</p>
                </div>
                <div class="col-md-8 mt-md-4">
                  <div class="row">
                    <div class="col-md-6">
                      <a class="mb-1 text-muted d-flex align-items-end text-h-primary"
                        ><i class="ph ph-globe me-2 f-18"></i>{{ $vendor->email }}</a
                      >
                      <div class="clearfix"></div>
                      <a class="mb-1 text-muted d-flex align-items-end text-h-primary"
                        ><i class="ph ph-phone me-2 f-18"></i>{{ $vendor->phone ?? 'N/A' }}</a
                      >
                    </div>
                    <!-- <div class="col-md-6">
                      <div class="d-flex">
            ...
            <div class="card">
              ...
              <div class="card-body border-top pro-det-edit collapse show" id="pro-det-edit-1">
                  ...
                  <div class="mb-3 row align-items-center">
                    ...
                    <div class="col-sm-9"> {{ ucfirst($vendor->gender ?? '-') }} </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Birth Date</label>
                    <div class="col-sm-9"> {{ $vendor->dob ? \Carbon\Carbon::parse($vendor->dob)->format('d-m-Y') : '' }} </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Marital Status</label>
                    <div class="col-sm-9"> {{ ucfirst($vendor->marital_status ?? '-') }} </div>
                  </div>
                  <div class="mb-3 row align-items-center">
              ...
              <div class="card-body border-top pro-det-edit collapse" id="pro-det-edit-2">
                <form method="POST" action="{{route('vendor.profile.personal')}}">
                  @csrf
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Full Name</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name= "name" placeholder="Full Name" value="{{ $vendor->name }}" />
                    </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Gender</label>
                  ...
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Birth Date</label>
                    <div class="col-sm-9">
                      <input type="date" name="dob" class="form-control" value="{{ $vendor->dob ? \Carbon\Carbon::parse($vendor->dob)->format('Y-m-d') : '' }}" />
                    </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Marital Status</label>
                    <div class="col-sm-9">
                      <select class="form-control" id="exampleFormControlSelect1" name="marital_status">
                        ...
                        <option value="married" {{ $vendor->marital_status === 'married' ? 'selected' : '' }} > Married</option>
                        <option value="unmarried" {{ $vendor->marital_status === 'unmarried' ? 'selected' : '' }}>Unmarried</option>
                      </select>
                    </div>
                  </div>
                  <div class="mb-3 row align-items-center">
            ...
            <div class="card">
              ...
              <div class="card-body border-top pro-dont-edit collapse show" id="pro-dont-edit-1">
                  <div class="mb-3 row align-items-center">
                    ...
                    <div class="col-sm-9"> {{ $vendor->phone ?? '-' }} </div>
                  </div>
                  <div class="mb-3 row align-items-center">
              ...
              <div class="card-body border-top pro-dont-edit collapse" id="pro-dont-edit-2">
                <form method="POST" action="{{ route('vendor.profile.contact')}}">
                  @csrf
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Mobile Number</label>
                    <div class="col-sm-9">
                      <input type="text" name="phone" class="form-control" maxlength="10" pattern="[0-9]{10}" inputmode="numeric" placeholder="Enter 10-digit mobile number" value="{{ $vendor->phone }}" />
                    </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                    <label class="col-sm-3 col-form-label font-weight-bolder">Email Address</label>

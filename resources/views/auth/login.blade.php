        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-lg rounded-4">
                ...
                <div class="card-header text-center fw-bold fs-4 rounded-top-4"
                    ...
                    <i class="bi bi-person-circle me-2"></i> {{ __('ADMIN Login') }}
                </div>
                ...
                <div class="card-body p-4"  >
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center">
                            <button type="submit"
                                    class="btn btn-dark btn-lg px-5 rounded-pill shadow-sm">
                        ...
                        <!-- <div class="text-center mt-4">
                            <p class="mb-0 text-muted">
                                ...
                                <a href="{{ route('admin.register') }}" class="text-decoration-none fw-semibold text-primary hover-underline">

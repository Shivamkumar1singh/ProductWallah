...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-success mb-2" href="{{ route('admin.productManagement.product.create') }}">
    ...
    <tbody>
        @forelse($products as $p)
            <tr>
                ...
                {{-- Actions --}}
                <td>
                    <a href="{{ route('admin.productManagement.product.edit', $p->id) }}" class="btn btn-sm btn-primary">
                        <i class="fa fa-edit"></i> Edit
                    </a>

                    <form method="POST" action="{{ route('admin.productManagement.product.destroy', $p->id) }}" style="display:inline;">
                        @csrf
                        @method('DELETE')
